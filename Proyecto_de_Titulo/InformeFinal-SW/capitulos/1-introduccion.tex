...
A diferencia de las herramientas actuales, \textit{DOMU} integra un sistema de registro de visitas que permite a los residentes pre-autorizar visitantes y a la conserjeria registrar ingresos y salidas con apoyo del escaneo del QR de la cedula de identidad chilena o mediante ingreso manual validado. Este flujo reduce errores de transcripcion, mejora la verificacion del visitante y deja trazabilidad de cada acceso asociado a una unidad habitacional.

Asimismo, la plataforma digitaliza el registro y retiro de encomiendas, el reporte y seguimiento de incidentes, la gestion de personal operativo y la asignacion de tareas, y la reserva de areas comunes con control de aforo, franjas horarias y restricciones aplicables por mora. El modulo financiero permite crear periodos de gastos comunes, cargar cargos, generar estados de cuenta en PDF y registrar pagos mediante la carga de comprobantes por parte del residente, los cuales quedan sujetos a validacion manual de la administracion.

La comunicacion interna se articula mediante un muro comunitario de publicaciones, chat en tiempo real entre residentes, marketplace comunitario y una biblioteca documental para reglamentos, actas y otros antecedentes de interes comun. Los residentes pueden participar en votaciones y consultar la informacion publicada, mientras que la administracion y el comite pueden gestionar votaciones, documentos comunitarios y resultados desde un mismo entorno.

De este modo, la aplicacion aborda de manera unificada la administracion interna, la experiencia del residente y la transparencia financiera, promoviendo eficiencia, coordinacion y trazabilidad en la convivencia diaria exigida por la Ley de Copropiedad Inmobiliaria.
...
En este contexto, la propuesta de \textit{DOMU} se justifica por su enfoque integral, centrado en una unica plataforma que conecta los procesos criticos de la administracion de comunidades residenciales. En lugar de depender de dispositivos fisicos especializados, el sistema aprovecha el computador de conserjeria y la web para permitir que los residentes pre-autoricen visitas y que la porteria verifique el ingreso mediante escaneo del QR de la cedula de identidad chilena para la validacion del RUN. Esta aproximacion reduce errores de transcripcion y mejora la trazabilidad sin requerir hardware adicional.

El control de accesos se complementa con la gestion de encomiendas desde su recepcion hasta el retiro, la gestion de incidentes con seguimiento administrativo, la reserva de areas comunes con reglas operativas y la administracion del personal operativo. El modulo financiero permite crear periodos de gastos comunes, cargar cargos, generar estados de cuenta en PDF y registrar pagos mediante comprobantes remitidos por el residente para su validacion manual. La comunicacion interna se apoya en un muro comunitario de publicaciones, chat en tiempo real, marketplace y biblioteca documental. Ademas, el sistema permite asignar y monitorear tareas del personal, realizar votaciones y administrar unidades habitacionales, residentes y comite desde un mismo entorno.
...
Desarrollar una plataforma web integral para la administracion de comunidades residenciales que integre y optimice los procesos criticos: registro y verificacion de visitas con pre-autorizacion y apoyo de escaneo del QR de la cedula de identidad chilena, trazabilidad de encomiendas, gestion de gastos comunes con generacion de estados de cuenta y registro de pagos mediante comprobante, asignacion y seguimiento de tareas al personal operativo, reporte y seguimiento de incidentes, reserva de areas comunes, y comunicacion interna mediante muro comunitario, chat y marketplace. El sistema debe ofrecer un entorno centralizado, trazabilidad de la informacion y acceso continuo para administradores, conserjes, residentes y comite.
