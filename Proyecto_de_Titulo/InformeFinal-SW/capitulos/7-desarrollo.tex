...
\begin{itemize}
    ...
    \item \textbf{Flujo de Pagos:} Implementación del flujo de revisión de cargos pendientes y carga de comprobantes de transferencia. El residente selecciona el período adeudado, consulta su detalle y adjunta el respaldo del pago, mientras que la administración revisa dicho comprobante y actualiza manualmente el estado del cargo.
...
\begin{itemize}
    ...
    \item \textbf{Muro Comunitario:} Módulo de publicaciones visibles para la comunidad, utilizado para difundir avisos, noticias y comunicaciones internas que los residentes pueden consultar desde la aplicación.
...
\begin{itemize}
    \item \textbf{Gestión de Personal:} CRUD completo para el registro de funcionarios (conserjes, personal de aseo, mayordomos), incluyendo la clasificación del tipo de personal y la visualización del personal activo.
