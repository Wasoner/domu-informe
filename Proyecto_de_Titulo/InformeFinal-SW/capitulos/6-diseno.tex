...
\begin{itemize}
    \item[\textbf{E.}] \textbf{Gestión de personal}: Administración de roles del personal asociado a la comunidad.
\end{itemize}
\begin{figure}[H]
    \centering
...
\begin{itemize}
    \item[\textbf{F.}] \textbf{Gestión de unidades}:  Control de unidades habitacionales dentro del conjunto residencial.
\end{itemize}
\begin{figure}[H]
    \centering
...
% --- H: Asignar tareas ---
\begin{itemize}
    \item[\textbf{H.}] \textbf{Asignación de tareas}: Coordinación de labores o encargos entre actores de la comunidad (conserjería u operaciones).
\end{itemize}
\begin{figure}[H]
    \centering
...
% --- I: Muro comunidad ---
\begin{itemize}
    \item[\textbf{I.}] \textbf{Muro de la comunidad}: Espacio de comunicación y publicaciones que puede compartir el administrador o el comite para la comunidad residencial.
\end{itemize}
\begin{figure}[H]
    \centering
