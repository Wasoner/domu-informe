...
Este anexo presenta la fuentes de recopilación de información utilizadas durante las etapas de análisis y diseño del proyecto DOMU. El material recolectado fue fundamental para levantar requerimientos funcionales, definir casos de uso y sustentar las principales decisiones de diseño del sistema. Se detallan tanto los métodos empleados como el aporte de cada fuente a la visión final del sistema.
...
%   \item Como \textbf{administrador}, quiero gestionar los residentes de mis edificios.
...
\begin{itemize}
    \item \textbf{Funcionalidades}: Módulos disponibles (finanzas, reservas, comunicación, control de acceso, votaciones).
