...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.78\textwidth]{capturas/RegistroVisitas.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{capturas/encomiendas.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{capturas/gastoscomunes.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{capturas/GestionResidentes.png}
