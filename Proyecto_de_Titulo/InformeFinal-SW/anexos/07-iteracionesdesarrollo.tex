...
7 & Documentación &
Generación automática de documentación OpenAPI y Swagger~UI. &
Semanas 16--17 &
API completamente documentada en Swagger~UI (\texttt{/swagger}). \\
...
% Fase 7 'Documentación' (Sem 16-17, azul oscuro) → Entregables: Swagger UI
%
...
\subsection{Fase 7: Documentación (Semanas 16--17)}

Última fase de desarrollo, dedicada a completar la documentación automatizada de la API mediante el plugin javalin-openapi y Swagger~UI.

\textbf{Entregables:} Swagger UI.

\textbf{Validación:} La documentación Swagger se confirmó accesible en \texttt{/swagger} con todos los endpoints registrados.